...
import { ToggleSwitchComponent } from '@signtech/shared/ui';
...
@Component({
  ...
  styles: [`
    .cookie-consent {
      ...
      background: white;
      color: var(--color-signtech-orange);
      padding: 1.5rem;
      z-index: 1000;
    ...
    .preferences-btn {
      ...
      border: 2px solid var(--color-signtech-orange);
      color: var(--color-signtech-orange);
    }
    ...
    .accept-btn {
      background: var(--color-signtech-orange);
      color: white;
    }
