...
import { ToggleSwitchComponent } from '@support-link/shared/ui';
...
@Component({
  ...
  styles: [`
    .cookie-consent {
      ...
      background: white;
      color: var(--color-support-link-orange);
      padding: 1.5rem;
      z-index: 1000;
    ...
    .preferences-btn {
      ...
      border: 2px solid var(--color-support-link-orange);
      color: var(--color-support-link-orange);
    }
    ...
    .accept-btn {
      background: var(--color-support-link-orange);
      color: white;
    }
